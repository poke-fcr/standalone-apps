...
typewriter
  .pauseFor(2500)
  .typeString(`<span style="color:  #dcd427; font-weight:600;"><b>You're Beautiful:</b> Let's start with the obvious. Your beauty is not just skin deep; it radiates from within.</span>`)
  .pauseFor(2500)
  .deleteAll(10)
  ...
  .pauseFor(2500)
  .deleteAll(10)
  .typeString(`<span style="color:  #dcd427; font-weight:600;"><b>Crush:</b> You've been the highlight of my thoughts. You've made me believe in the power of long-lasting admiration.</span>`)
  .pauseFor(2500)
  .deleteAll(10)
  ...
  .pauseFor(2500)
  .deleteAll(10)
  .typeString(`<span style="color:  #dcd427; font-weight:600;"><b>Chemistry:</b> There's something special about the connection we share. It's like our souls recognize each other, even before our minds do.</span>`)
  .pauseFor(2500)
  .deleteAll(10)
  ...
  .pauseFor(2500)
  .deleteAll(10)
  .typeString(`<span style="color:  #dcd427; font-weight:600;"><b>Adventure:</b> Life with you promises to be an adventure. Whether it's trying new things or exploring new places, I know we'd make incredible memories together.</span>`)
  .pauseFor(2500)
  .deleteAll(10)
  ...
  .pauseFor(2500)
  .deleteAll(10)
  .typeString(`<span style="color:  #dcd427; font-weight:600;"><b>Respect:</b> I respect you for who you are and what you stand for. Your independence and strength are incredibly admirable.</span>`)
  .pauseFor(2500)
  .deleteAll(10)
  ...
  .pauseFor(2500)
  .deleteAll(10)
  .typeString(`<span style="color:  #dcd427; font-weight:600;"><b>Unconditional Care:</b> My feelings for you are genuine, and I would always prioritize your happiness and well-being.</span>`)
  .pauseFor(2500)
  .deleteAll(10)
